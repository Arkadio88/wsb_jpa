...
insert into patient (date_of_birth, address_id, id, email, first_name, last_name, patient_number, telephone_number)
            values (PARSEDATETIME('29.03.1989', 'dd.MM.yyyy'), 5, 01, 'arkadion99gamil@o2.pl', 'Arkadio', 'Morales', 101, 724120190),
                   (PARSEDATETIME('31.01.1990', 'dd.MM.yyyy'), 6, 02, 'paulaantongamil@o2.pl', 'Paulucha', 'Anton', 102, 693393567),
                   (PARSEDATETIME('21.02.1987', 'dd.MM.yyyy'), 7, 03, 'dominodomino@o2.pl', 'Dominik', 'Bieln', 103, 697803557),
                   (PARSEDATETIME('05.05.1998', 'dd.MM.yyyy'), 8, 04, 'mateoussnba@gmail.pl', 'Mateusz', 'Stempin', 104, 889665111),
                   (PARSEDATETIME('07.12.1996', 'dd.MM.yyyy'), 9, 05, 'jatoja@o2.pl', 'Łukasz', 'Anmateus', 105, 688883567),
                   (PARSEDATETIME('20.11.1985', 'dd.MM.yyyy'), 10, 06, 'tytoty@o2.pl', 'Artur', 'Anton', 106, 693378590);
